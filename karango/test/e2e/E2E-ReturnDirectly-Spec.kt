...
class `E2E-ReturnDirectly-Spec` : StringSpec({
    ...
    "Directly returning a domain object" {
        ...
        assertSoftly {
            ...
            withClue("TypeRef for deserialization") {
                @Suppress("RemoveExplicitTypeArguments")
                result.query.ret.innerType().toString() shouldBe "class ${X::class.qualifiedName}"
            }

            withClue("TypeRef of TerminalExpr") {
                @Suppress("RemoveExplicitTypeArguments")
                result.query.ret.getType().toString() shouldBe "java.util.List<${X::class.qualifiedName}>"
            }
        }
    }
    ...
    "Directly returning a list of domain objects" {
        ...
        assertSoftly {
            ...
            withClue("TypeRef for deserialization") {
                @Suppress("RemoveExplicitTypeArguments")
                result.query.ret.innerType().toString() shouldBe "java.util.List<? extends ${X::class.qualifiedName}>"
            }

            withClue("TypeRef of TerminalExpr") {
                @Suppress("RemoveExplicitTypeArguments")
                result.query.ret.getType().toString() shouldBe "java.util.List<java.util.List<? extends ${X::class.qualifiedName}>>"
            }
        }
    }
        ...
        assertSoftly {
            ...
            withClue("TypeRef for deserialization") {
                ...
                result.query.ret.innerType().toString() shouldBe 
                        "java.util.Map<java.lang.String, ? extends ${X::class.qualifiedName}>"
            }

            withClue("TypeRef of TerminalExpr") {
                @Suppress("RemoveExplicitTypeArguments")
                result.query.ret.getType().toString() shouldBe 
                        "java.util.List<java.util.Map<java.lang.String, ? extends ${X::class.qualifiedName}>>"
            }
        }
    }
    ...
    "Directly returning a map of strings to lists of domain objects" {
        ...
        val data = mapOf(
            "a" to listOf(X("Eddard", 42), X("John", 22)),
            "b" to listOf() 
        )
        ...
        assertSoftly {
            ...
            withClue("TypeRef for deserialization") {
                @Suppress("RemoveExplicitTypeArguments")
                result.query.ret.innerType().toString() shouldBe
                        "java.util.Map<java.lang.String, ? extends java.util.List<? extends ${X::class.qualifiedName}>>"
            }

            withClue("TypeRef of TerminalExpr") {
                @Suppress("RemoveExplicitTypeArguments")
                result.query.ret.getType().toString() shouldBe
                        "java.util.List<java.util.Map<java.lang.String, ? extends java.util.List<? extends ${X::class.qualifiedName}>>>"
            }
        }
    }
